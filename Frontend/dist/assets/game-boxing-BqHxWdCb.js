import{P as O}from"./phaser-iZDVk5aZ.js";class W extends O.Scene{constructor(){super({key:"BoxingGameScene"}),this._ui=[]}init(a={}){this.onGameEnd=a.onGameEnd??null,this.roomCode=a.roomCode??null,this.player=a.player??null,this.roundId=a.roundId??null}preload(){}create(){const{width:a,height:i}=this.scale;this.add.rectangle(a/2,i/2,a,i,1706496),this._buildOverlay(),this.events.once("shutdown",()=>this._destroyUI()),this.events.once("destroy",()=>this._destroyUI())}_buildOverlay(){const a=this._el("div",{id:"bg-overlay",style:`
    ...
    `,o.appendChild(this._hudBox('<span id="bg-timer" style="color:#d32f2f;">เวลา:20</span>')),o.appendChild(this._hudBox('<span id="bg-score" style="color:#2e7d32;">คะแนน:0</span>')),f.appendChild(o);const m=this._el("div");m.style.cssText=`
    ...
    `,a.appendChild(u),document.body.appendChild(a),this._ui.push(a),this._initGame()}_hudBox(a){const i=this._el("div");i.style.cssText=`
    ...
    `;const c=this._el("div");return c.style.cssText=`
      ...
      letter-spacing: 1px;
    `,c.innerHTML=a,i.appendChild(c),i}_buildStartScreen(){const a=this._el("div",{id:"bg-start-screen"});a.style.cssText=`
    ...
    `,f.textContent="",i.appendChild(f);const o=this._el("div");o.style.cssText=`
    ...
    `,o.innerHTML="จดจำท่ามวยและชื่อให้แม่น จากนั้นลากป้ายชื่อไปวางบนเงาที่ถูกต้องให้ครบก่อนหมดเวลา",i.appendChild(o);const m=this._el("button");m.style.cssText=`
    ...
    `,m.textContent="เริ่มเกม",m.onclick=()=>this._startGame();const x=this._el("div");return x.style.cssText="display:flex;flex-direction:column;align-items:center;",x.appendChild(m),i.appendChild(x),a.appendChild(i),a}_buildResultModal(){const a=this._el("div",{id:"bg-result-modal"});a.style.cssText=`
    ...
    `,i.appendChild(c);const g=this._el("div");g.style.cssText=`
      position: absolute; top: 88px; left: 50%; transform: translateX(-50%);
      color: #fff0d2; font-size: 1.08rem; font-weight: 700;
      text-shadow: 0 2px 8px rgba(0,0,0,0.8);
    `,g.textContent="คะแนนรวมจากท่าที่วางถูกต้องทั้งหมด",i.appendChild(g);const f=this._el("div",{id:"bg-final-score"});f.style.cssText=`
    ...
    `,f.textContent="0",i.appendChild(f);const o=this._el("button");return o.style.cssText=`
    ...
    `,o.textContent="กลับไปแผนที่",o.onclick=()=>{var x,b;const m=((x=this._gs)==null?void 0:x.score)??0;this._destroyUI(),(b=this.onGameEnd)==null||b.call(this,{score:m})},i.appendChild(o),a.appendChild(i),a}_initGame(){const a="/assets/boxing/",i=a+"images/",c=a+"sounds/",g=[{id:1,imgColor:`${i}ท่ามวยสี1.png`,imgShadow:`${i}ท่ามวยเงา1.png`,imgName:`${i}ป้าย11.png`},{id:2,imgColor:`${i}ท่ามวยสี2.png`,imgShadow:`${i}ท่ามวยเงา2.png`,imgName:`${i}ป้าย2.png`},{id:3,imgColor:`${i}ท่ามวยสี3.png`,imgShadow:`${i}ท่ามวยเงา3.png`,imgName:`${i}ป้าย3.png`},{id:4,imgColor:`${i}ท่ามวยสี4.png`,imgShadow:`${i}ท่ามวยเงา4.png`,imgName:`${i}ป้าย4.png`},{id:5,imgColor:`${i}ท่ามวยสี5.png`,imgShadow:`${i}ท่ามวยเงา5.png`,imgName:`${i}ป้าย6.png`}],f=[{id:99,imgName:`${i}ป้ายหลอก1.png`},{id:100,imgName:`${i}ป้ายหลอก2.png`}],o={score:0,timeLeft:20,playTime:15,isPlaying:!1,timerInterval:null,hasShuffledMidGame:!1};this._gs=o;const m=new Audio(`${c}npc_voice.mp3`),x=new Audio(`${c}321.mp3`),b=new Audio(`${c}start_go.mp3`),u=new Audio(`${c}bg_music.mp3`);u.loop=!0,u.volume=.4,this._bgMusic=u;const A=()=>{try{u.currentTime=0,u.play().catch(()=>{})}catch{}},L=()=>{try{u.pause(),u.currentTime=0}catch{}},I=e=>{if(e)try{e.pause(),e.currentTime=0,e.play().catch(()=>{})}catch{}},y=e=>{try{const t=window.AudioContext||window.webkitAudioContext;if(!t)return;this._audioCtx||(this._audioCtx=new t);const n=this._audioCtx,s=n.currentTime,p=n.createOscillator(),d=n.createGain();p.connect(d),d.connect(n.destination);const l={pick:{type:"triangle",start:260,end:420,dur:.12,vol:.028},alert:{type:"square",start:420,end:170,dur:.22,vol:.036},success:{type:"triangle",start:420,end:820,dur:.2,vol:.034},wrong:{type:"sawtooth",start:240,end:110,dur:.18,vol:.026},finish:{type:"sine",start:520,end:940,dur:.28,vol:.035}}[e];if(!l)return;p.type=l.type,p.frequency.setValueAtTime(l.start,s),p.frequency.exponentialRampToValueAtTime(l.end,s+l.dur),d.gain.setValueAtTime(1e-4,s),d.gain.exponentialRampToValueAtTime(l.vol,s+.01),d.gain.exponentialRampToValueAtTime(1e-4,s+l.dur),p.start(s),p.stop(s+l.dur+.02)}catch{}},G="สวัสดีขอรับ! จำท่ามวยและชื่อท่าให้แม่นภายใน 20 วินาที แล้วลากป้ายชื่อไปวางบนเงาให้ถูกต้องนะ!";function N(e,t,n,s=!1){if(!t)return;t.textContent="",s&&I(m);let p=0;const d=()=>{p<e.length&&(t.textContent+=e[p++],setTimeout(d,n))};d()}const E=()=>document.getElementById("bg-board"),C=()=>document.getElementById("bg-deck"),_=()=>document.getElementById("bg-instruction");function z(e){const t=document.createElement("img");return t.src=e.imgName,t.className="bg-name-card",t.id=`bg-card-${e.id}`,t.dataset.id=e.id,t.draggable=!1,t.onerror=()=>{const n=document.createElement("div");n.className="bg-name-card bg-name-card-text",n.id=`bg-card-${e.id}`,n.dataset.id=e.id,n.textContent=`ท่าที่ ${e.id}`,t.replaceWith(n)},t.addEventListener("dragstart",n=>n.dataTransfer.setData("text",n.target.id)),t}function S(e){e.preventDefault()}function $(e){if(e.preventDefault(),!o.isPlaying)return;const t=e.dataTransfer.getData("text"),n=document.getElementById(t);if(!n)return;const s=e.target.closest(".bg-drop-zone")||e.target.closest("#bg-deck");s&&((s.id==="bg-deck"||s.children.length===0)&&s.appendChild(n),y("pick"),B())}function B(){let e=0;document.querySelectorAll(".bg-drop-zone").forEach(s=>{s.children.length>0&&e++});const t=document.getElementById("bg-placed-count"),n=document.getElementById("bg-progress-fill");t&&(t.textContent=e),n&&(n.style.width=`${e/5*100}%`),e===5&&o.isPlaying&&setTimeout(()=>M(!1),500)}function q(){const e=E();if(!e)return;e.innerHTML="",g.forEach(n=>{const s=document.createElement("div");s.className="bg-card-container",s.dataset.slotId=n.id;const p=document.createElement("div");p.className="bg-image-box";const d=document.createElement("img");d.src=n.imgShadow,d.id=`bg-img-display-${n.id}`,d.className="bg-real-img",p.appendChild(d);const r=document.createElement("div");r.className="bg-drop-zone",r.addEventListener("drop",$),r.addEventListener("dragover",S),s.appendChild(p),s.appendChild(r),e.appendChild(s)});const t=C();t&&(t.innerHTML="",t.style.display="none",t.addEventListener("drop",$),t.addEventListener("dragover",S)),N(G,document.getElementById("bg-npc-speech"),80,!0)}this._startGame=()=>{const e=document.getElementById("bg-start-screen");e&&(e.style.display="none");try{m.pause(),m.currentTime=0}catch{}j()};const w=e=>new Promise(t=>setTimeout(t,e));async function j(){const e=document.getElementById("bg-countdown-overlay"),t=document.getElementById("bg-countdown-text");e&&(e.style.display="flex"),I(x);for(let s=3;s>0;s--)t&&(t.textContent=s,t.style.animation="none",t.offsetWidth,t.style.animation="bg-count-bounce 0.5s ease-out forwards"),await w(1e3);t&&(t.textContent="เริ่ม!",t.style.animation="none",t.offsetWidth,t.style.animation="bg-count-bounce 0.5s ease-out forwards"),I(b),await w(800),e&&(e.style.display="none");const n=document.getElementById("bg-main");n&&n.classList.remove("bg-hidden"),A(),P()}function P(){g.forEach(e=>{const t=document.getElementById(`bg-img-display-${e.id}`);t&&(t.src=e.imgColor);const n=document.querySelector(`[data-slot-id="${e.id}"]`);if(!n)return;const s=n.querySelector(".bg-drop-zone");s.innerHTML="";const p=z(e);s.appendChild(p)}),H()}function H(){o.timeLeft=20;const e=document.getElementById("bg-timer");e&&(e.textContent=`เวลา:${o.timeLeft}`);const t=_();t&&(t.textContent="ช่วงจดจำ: จำรูปท่าและชื่อให้แม่น!",t.style.color="#ffd700"),o.timerInterval&&clearInterval(o.timerInterval),o.timerInterval=setInterval(()=>{o.timeLeft--;const n=document.getElementById("bg-timer");n&&(n.textContent=`เวลา:${o.timeLeft}`),o.timeLeft<=0&&(clearInterval(o.timerInterval),D())},1e3)}async function R(){const e=_();e&&(e.textContent="⚠️ ระวัง! ท่ามวยสลับตำแหน่ง!",e.style.filter="drop-shadow(0 0 10px #ff0000)"),y("alert");const t=E();if(!t)return;const n=Array.from(t.querySelectorAll(".bg-card-container"));t.style.animation="bg-shake 0.5s",await w(500),t.style.animation="",n.sort(()=>Math.random()-.5),n.forEach(s=>t.appendChild(s)),t.style.backgroundColor="rgba(255,255,255,0.3)",await w(100),t.style.backgroundColor="transparent",e&&(e.style.filter="")}async function D(){const e=_();e&&(e.textContent="กำลังสลับไพ่...");const t=E();if(!t)return;const n=Array.from(t.querySelectorAll(".bg-card-container"));n.forEach(r=>{const l=r.querySelector(".bg-drop-zone");l.style.opacity="0",l.innerHTML=""});const s=t.getBoundingClientRect(),p=s.left+s.width/2,d=s.top+s.height/2;n.forEach((r,l)=>{const h=r.getBoundingClientRect(),v=p-(h.left+h.width/2),T=d-(h.top+h.height/2),k=Math.random()*10-5;r.style.transition="transform 0.5s cubic-bezier(0.25,1,0.5,1)",r.style.zIndex=l+10,setTimeout(()=>{r.style.transform=`translate(${v}px,${T}px) rotate(${k}deg)`},l*150)}),await w(500+n.length*150),g.forEach(r=>{const l=document.getElementById(`bg-img-display-${r.id}`);l&&(l.src=r.imgShadow)}),n.forEach(r=>{r.style.transition="none",r.style.transform="",r.style.zIndex=""}),n.sort(()=>Math.random()-.5),n.forEach(r=>t.appendChild(r)),n.forEach(r=>{const l=r.getBoundingClientRect(),h=p-(l.left+l.width/2),v=d-(l.top+l.height/2);r.style.transform=`translate(${h}px,${v}px)`}),document.body.offsetHeight,n.forEach((r,l)=>{r.style.transition="transform 0.6s cubic-bezier(0.25,1,0.5,1)",r.querySelector(".bg-drop-zone").style.opacity="1",setTimeout(()=>{r.style.transform=""},l*150)}),await w(600+n.length*150),n.forEach(r=>{r.style.transition="",r.style.transform=""}),X()}function X(){o.isPlaying=!0,o.playTime=15;const e=_();e&&(e.textContent="ระวังป้ายหลอก ลากป้ายที่ถูกต้องไปวางบนรูปเงาให้ครบ",e.style.color="");const t=C();if(!t)return;t.style.display="flex",t.innerHTML="";const n=[...g,...f];n.sort(()=>Math.random()-.5),n.forEach(s=>{const p=z(s);p.draggable=!0,t.appendChild(p)}),B(),Y()}function Y(){o.timerInterval&&clearInterval(o.timerInterval),o.hasShuffledMidGame=!1;const e=document.getElementById("bg-timer");e&&(e.textContent=`เวลา:${o.playTime}`),o.timerInterval=setInterval(()=>{o.playTime--;const t=document.getElementById("bg-timer");t&&(t.textContent=`เวลา:${o.playTime}`),o.playTime===5&&!o.hasShuffledMidGame&&(R(),o.hasShuffledMidGame=!0),o.playTime<=0&&(clearInterval(o.timerInterval),M(!0))},1e3)}async function M(e=!1){var p;clearInterval(o.timerInterval),o.isPlaying=!1,L(),document.querySelectorAll(".bg-name-card").forEach(d=>d.draggable=!1);const t=document.querySelectorAll(".bg-card-container");let n=0;t.forEach(d=>{const r=parseInt(d.dataset.slotId),l=d.querySelector(".bg-drop-zone");let h=!1;l.children.length>0&&parseInt(l.children[0].dataset.id)===r&&(n+=10,h=!0),d.classList.remove("bg-correct-box","bg-wrong-box"),d.classList.add(h?"bg-correct-box":"bg-wrong-box");const v=d.querySelector(".bg-real-img"),T=g.find(k=>k.id===r);v&&T&&(v.src=T.imgColor)}),n>=40?y("success"):n>0?y("pick"):y("wrong"),o.score=n;const s=document.getElementById("bg-score");s&&(s.textContent=`คะแนน:${n}`),(p=C())!=null&&p.style&&(C().style.display="none"),setTimeout(()=>{y("finish");const d=document.getElementById("bg-result-modal"),r=document.getElementById("bg-final-score");d&&(d.style.display="flex"),r&&(r.textContent=n)},800)}q()}_getCSS(){return`
    ...
    `}_el(a,i={}){const c=document.createElement(a);return Object.entries(i).forEach(([g,f])=>{g==="style"?c.style.cssText=f:c.setAttribute(g,f)}),c}_destroyUI(){var a;if(this._bgMusic){try{this._bgMusic.pause()}catch{}this._bgMusic=null}(a=this._gs)!=null&&a.timerInterval&&clearInterval(this._gs.timerInterval),this._ui.forEach(i=>{try{i.remove()}catch{}}),this._ui=[]}}export{W as B};
