import{P as D}from"./phaser-iZDVk5aZ.js";class q extends D.Scene{constructor(){super({key:"CookingGameScene"}),this._ui=[]}init(l={}){this.onGameEnd=l.onGameEnd??null,this.roomCode=l.roomCode??null,this.player=l.player??null,this.roundId=l.roundId??null}preload(){}create(){const{width:l,height:s}=this.scale;this.add.rectangle(l/2,s/2,l,s,1710592),this._buildOverlay(),this.events.once("shutdown",()=>this._destroyUI()),this.events.once("destroy",()=>this._destroyUI())}_buildOverlay(){const l="/cooking/",s=l+"images/",a=this._el("div",{id:"ck-overlay",style:`
      ...
      `}),c=this._el("style");c.textContent=this._getCSS(s),a.appendChild(c),a.appendChild(this._buildStartScreen(s));const f=this._el("div",{id:"ck-countdown-overlay"}),b=this._el("div",{id:"ck-countdown-text"});f.appendChild(b),a.appendChild(f),a.appendChild(this._buildResultScreen(s));const _=this._el("div",{id:"ck-timer",class:"ck-hidden"});_.textContent="เวลา: 45",a.appendChild(_);const I=this._el("div",{id:"ck-npc-area",class:"ck-npc-area"}),h=this._el("div",{class:"ck-speech-bubble"}),C=this._el("p",{id:"ck-npc-text"});C.textContent="รอก่อนนะหลาน...",h.appendChild(C);const i=this._el("img");i.src=`${s}ยาย.png`,i.className="ck-grandma",i.onerror=()=>{i.style.display="none"},I.appendChild(h),I.appendChild(i),a.appendChild(I);const u=this._el("img",{id:"ck-table-decor",class:"ck-table-decor"});u.src=`${s}table.png`,u.onerror=()=>{u.style.display="none"},a.appendChild(u);const x=this._el("div",{class:"ck-table-area",id:"ck-table-area"});a.appendChild(x);const d=this._el("div",{id:"ck-bowl",class:"ck-bowl-container"}),T=this._el("div",{id:"ck-stir-progress",class:"ck-hidden"});T.innerHTML='<div id="ck-stir-bar-bg"><div id="ck-stir-bar"></div></div>',d.appendChild(T);const E=this._el("div",{id:"ck-stir-hint",class:"ck-hidden ck-stir-hint"});E.innerHTML=`
