  ...
  buildDom() {
    ...
    this.root.innerHTML = `
      <style>
        ...
        .dg-stats-left { left: 30px; }
        .dg-stats-right { right: 30px; align-items: flex-end; }
        .dg-stat {
          width: 160px;
          height: 60px;
          display: flex;
        ...
        .dg-button:hover { transform: translateY(-3px) scale(1.05); }
