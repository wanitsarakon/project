  ...
  mount() {
    ...
    this.root.innerHTML = `
      ...
      <div class="fl-root">
        ...
        <div id="startOverlay" class="fl-overlay"><div class="fl-panel"><h2>ร้านร้อยพวงมาลัยไทย</h2><p class="fl-panel-copy">รับลูกค้าหลายคิวพร้อมกัน เลือกคนที่ต้องการบริการ แล้วร้อยพวงมาลัยตามแบบให้ถูกต้องก่อนความอดทนของลูกค้าจะหมดลง</p><div class="fl-start-chips"><div class="fl-chip-soft">น้ำอบ 3 ครั้ง</div><div class="fl-chip-soft">ธูปช่วยร้อย 1 ครั้ง</div><div class="fl-chip-soft">คอมโบเพิ่มคะแนน</div></div><button id="startBtn" class="fl-mainbtn">เริ่มเกม</button><button id="tutorialBtn" class="fl-subbtn">ดูวิธีเล่น</button></div></div>
        ...
        <div id="resultOverlay" class="fl-result" style="display:none"><div class="fl-resultcard"><div class="fl-resulttitle">สรุปผลงานร้านพวงมาลัย</div><div id="finalScore" class="fl-resultscore">0</div><div id="finalMeta" class="fl-resultmeta"></div><button id="finishBtn" class="fl-mainbtn" style="margin-top:22px">กลับไปแผนที่</button></div></div>
      </div>
    `;
