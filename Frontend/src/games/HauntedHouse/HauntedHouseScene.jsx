  ...
  mount() {
    ...
    this.root.innerHTML = `
      ...
      <div class="hh-root">
        ...
        <div id="result" class="hh-screen hh-result hh-hidden"><div class="hh-overlay"><div class="hh-card"><img class="hh-npc" src="${ASSET_BASE}/images/npc1.png" alt="npc"/><div class="hh-board hh-result-board"><h2 class="hh-title">บทสรุปดวงวิญญาณ</h2><div class="hh-copy">วิญญาณแต่ละตนจะสงบลงเมื่อได้รับของที่ต้องการครบ คุณยังได้คะแนนจากของที่ถือกลับมาเหลืออยู่ด้วย</div><div id="score" class="hh-score">0 / ${MAX_SCORE}</div><div id="summary" class="hh-summary"></div><button id="finish" class="hh-btn" style="margin-top:22px">กลับไปแผนที่</button></div></div></div></div>
