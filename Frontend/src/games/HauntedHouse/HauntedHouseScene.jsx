  ...
  mount() {
    ...
    this.root.innerHTML = `
      ...
      <div class="hh-root">
        ...
        <div id="room" class="hh-screen hh-hidden"><div id="roomBg" class="hh-bg"></div><div class="hh-dim"></div><div class="hh-top"><img id="roomSign" class="hh-sign" alt="room sign"/><div style="display:flex;gap:10px;flex-wrap:wrap;justify-content:flex-end"><div id="roomTitle" class="hh-chip"></div><div class="hh-chip hh-stat">เวลา <span id="time">30</span></div></div></div><div id="roomStage" class="hh-room"><div id="miss" class="hh-miss"></div></div><div class="hh-bottom"><div class="hh-hint">หาของที่ซ่อนอยู่ในห้องนี้ให้ครบก่อนเวลาหมด</div><div id="roomItems" class="hh-items"></div></div></div>
