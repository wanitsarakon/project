...
const START_SIGN = new URL("./assetsHorse/ขี่ม้าเริ่มเกม.jpg", import.meta.url).href;
const RESULT_SIGN = new URL("./assetsHorse/ขี่ม้าคะเนน.jpg", import.meta.url).href;
