...
const clickGeneric = new Audio('sounds/click.mp3'); // (เผื่อไว้) เสียงคลิกทั่วไป
...
const freezeSound = new Audio('sounds/freeze.mp3'); // เปลี่ยน path เป็นไฟล์ของคุณ
